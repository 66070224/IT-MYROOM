...
function Page() {
    ...
    const seats = Array.from({ length: 10 }, (_, rowIndex) =>
        Array.from({ length: 8 }, (_, colIndex) => {
            ...
            return seatNumber.toString().padStart(9, 'Lab203-0');
        })
    );
    ...
    useEffect(() => {
        ...
        const fetchRoom = async () => {
            try {
                ...
                const { labrooms } = await response.json();

                if (labrooms[0]?.available === false) {
                    setAvailable(false);
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg">
        ...
        <h2 className="text-center text-black font-bold mb-4">LAB-203 RESERVATION</h2>
